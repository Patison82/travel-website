...
const Icons = () => {
  useEffect(() => {
    ...
    script.src = "https://bot.jaicp.com/chatwidget/rtNasDNc:80a5c7fd1b9a17adb67ca42aec2804c4c802f757/justwidget.js?force=true";
    script.async = true;
  ...
  const icons = [
    {
      ...
      title: "Flights",
      description: "Plus hotel, transfers & meals",
      link: "/flights",
    },
    {
      ...
      title: "Help 24/7",
      description: "Friendly service with chat support",
      link: "/",
    },
    {
      ...
      title: "High Quality",
      description: "Relax in top notch hotels",
      link: "/hotels",
    },
    {
      ...
      description: "Features you'll get the best",
      link: "/about",
    },
  ];
