...
const Icon = ({ icon, title, description }) => {
  return (
    <div className="flex flex-col items-center text-center">
      <div className="bg-teal-400 rounded-full p-6 mb-4 text-white flex items-center justify-center">
        <div
...
const Icons = () => {
  const icons = [
    ...
    },
    {
      ...
      title: "Help 24/7",
      description: "Friendly service plus a 24/7",
    },
    {
    ...
    },
    {
      ...
      description: "Feature you’ll get the best",
    },
  ];
